...
export default function MySkills() {
  ...
  const handleResumeDelete = async () => {
    ...
    try {
      ...
      showToast('Resume path cleared. Please upload a new document.', 'success');
      setApplicantProfile(prev => ({ ...prev, resume: null }));
    } catch (err) {
      showToast('Failed to update resume reference.', 'error');
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="pb-8 border-b border-[#EAE2D5] mb-12 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-serif text-[#241E1A] uppercase tracking-tight font-medium flex items-center gap-2">
          ...
          <button
            ...
            disabled={isSaving}
            className="bg-[#241E1A] text-[#FAF6F0] hover:bg-[#382F29] text-[10px] font-bold uppercase tracking-wider px-5 py-3 rounded-xl transition-all shadow-3xs disabled:opacity-50 cursor-pointer flex items-center gap-2 self-start md:self-auto"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
          {/* Card 1: Added Skills */}
          <div className="bg-[#FCF9F3] border border-[#EAE2D5] p-6 rounded-2xl shadow-xs flex items-center gap-4 relative overflow-hidden hover:shadow-sm hover:scale-[1.02] transition-all duration-300">
            <div className="absolute top-0 right-0 w-16 h-16 bg-[#F4ECE1] rounded-bl-full opacity-35" />
            <div className="w-10 h-10 rounded-xl bg-[#241E1A] text-[#FDFBF7] flex items-center justify-center font-bold relative z-10 shadow-3xs">
              {skills.length}
            </div>
            <div className="relative z-10">
              <p className="text-[9px] font-bold text-stone-400 uppercase tracking-widest">Profile Talents</p>
              <p className="text-sm font-bold uppercase text-[#241E1A] mt-0.5">Added Skills</p>
            </div>
          </div>

          {/* Card 2: Certified Skills */}
          <div className="bg-[#FCF9F3] border border-[#EAE2D5] p-6 rounded-2xl shadow-xs flex items-center gap-4 relative overflow-hidden hover:shadow-sm hover:scale-[1.02] transition-all duration-300">
            <div className="absolute top-0 right-0 w-16 h-16 bg-emerald-50 rounded-bl-full opacity-50" />
            <div className="w-10 h-10 rounded-xl bg-emerald-600 text-white flex items-center justify-center font-bold relative z-10 shadow-3xs">
              {certifiedSkills.length}
            </div>
            <div className="relative z-10">
              <p className="text-[9px] font-bold text-stone-400 uppercase tracking-widest">Verified Badges</p>
              <p className="text-sm font-bold uppercase text-emerald-800 mt-0.5">Certified Skills</p>
            </div>
          </div>

          {/* Card 3: Non-Certified */}
          <div className="bg-[#FCF9F3] border border-[#EAE2D5] p-6 rounded-2xl shadow-xs flex items-center gap-4 relative overflow-hidden hover:shadow-sm hover:scale-[1.02] transition-all duration-300">
            <div className="absolute top-0 right-0 w-16 h-16 bg-amber-50 rounded-bl-full opacity-50" />
            <div className="w-10 h-10 rounded-xl bg-amber-600 text-white flex items-center justify-center font-bold relative z-10 shadow-3xs">
              {nonCertifiedSkills.length}
            </div>
            <div className="relative z-10">
              <p className="text-[9px] font-bold text-stone-400 uppercase tracking-widest">Awaiting Verification</p>
              <p className="text-sm font-bold uppercase text-amber-800 mt-0.5">Unverified Skills</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="bg-white border border-[#EAE2D5] p-8 rounded-[32px] shadow-xs">
              <h2 className="text-xs font-bold text-[#241E1A] uppercase tracking-widest mb-6 flex items-center gap-2 pb-3 border-b border-[#EAE2D5]">
              ...
              <div className="flex flex-col gap-4">
                <label className={`inline-flex items-center justify-center gap-2 bg-[#FAF6F0] border border-dashed border-[#241E1A] hover:bg-[#F4ECE1] text-[#241E1A] text-xs font-semibold uppercase tracking-wider px-4 py-4 rounded-xl transition-all cursor-pointer shadow-3xs ${isUploading ? 'opacity-50 pointer-events-none' : ''}`}>
                ...
                {applicantProfile?.resume && (
                  <div className="flex items-center justify-between p-4 bg-[#FCF9F3] border border-[#EAE2D5] rounded-2xl">
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1 text-xs font-bold text-[#241E1A] hover:text-stone-500 transition-colors"
                      >
                ...
                <div className="mt-8 pt-8 border-t border-[#EAE2D5] space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="bg-[#241E1A] text-[#FAF6F0] hover:bg-[#382F29] text-[10px] font-bold uppercase tracking-wider px-4 py-2.5 rounded-xl transition-all shadow-3xs disabled:opacity-50 cursor-pointer flex items-center gap-1.5"
                    >
                  ...
                  {extractedSkills.length > 0 ? (
                    <div className="space-y-3 p-4 bg-[#FCF9F3] border border-[#EAE2D5] rounded-2xl animate-in fade-in slide-in-from-top-2">
                      <p className="text-[9px] font-extrabold text-stone-500 uppercase tracking-widest border-b border-[#EAE2D5] pb-1.5">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {extractedSkills.map((skill, idx) => (
                          <button
                            ...
                            className="bg-white hover:bg-[#F4ECE1] text-[#241E1A] border border-[#EAE2D5] text-[10px] font-semibold px-2.5 py-1 rounded-lg transition-all flex items-center gap-1 shadow-3xs transform hover:-translate-y-0.5"
                          >
                    ...
                    <div className="p-4 bg-[#FAF6F0] rounded-2xl border border-dashed border-[#EAE2D5] text-center text-stone-400 text-[10px]">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="bg-white border border-[#EAE2D5] p-6 rounded-2xl shadow-xs relative overflow-hidden flex flex-col justify-between min-h-[220px]">
                <div>
                  ...
                  <h2 className="text-xs font-bold text-[#241E1A] uppercase tracking-widest mb-2 flex items-center gap-2 relative z-10 border-b border-[#EAE2D5] pb-2">
              ...
              <div className="bg-white border border-[#EAE2D5] p-6 rounded-2xl shadow-xs relative overflow-hidden flex flex-col justify-between min-h-[220px]">
                <div>
                  ...
                  <p className="text-[10px] text-stone-500 mb-4 relative z-10">Capabilities added to your profile but not yet verified.</p>
                ...
                {nonCertifiedSkills.length > 0 && (
                  <button
                    ...
                    className="w-full bg-[#241E1A] hover:bg-[#382F29] text-[#FAF6F0] text-[10px] font-bold uppercase tracking-wider py-3 rounded-xl transition-all flex items-center justify-center gap-1.5 shadow-sm mt-2 cursor-pointer border border-[#EAE2D5]"
                  >
                    {isCertifying ? 'Processing...' : 'Get Certification Now'}
